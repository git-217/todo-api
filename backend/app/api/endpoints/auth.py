...
from app.schemas.users_schema import UserRegisterSchema, UserAuthSchema, UserBasicSchema
...
async def register(
    new_user: UserRegisterSchema, user_service: UserService = Depends(get_user_service)
